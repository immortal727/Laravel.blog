...
@section('content')
    ...
    <h1>Авторизированный сервис по изготовлению и ремонту электродвигателей</h1>
    <strong class="title">ООО "Энергоремонт-Сервис" изготавливает:</strong>
    <ul>
        <li>Стержневые обмотки для турбогенераторов;</li>
        <li>Секции для высоковольтных электродвигателей 3кВ; 6кВ; 10кВ;</li>
        <li> Катушечные статорные обмотки;</li>
        <li>Коллекторы для машин постоянного тока: арочные, цилиндрические с бандажными кольцами, комбинированные;</li>
    </ul>
    <h2>Ремонт и перемотка электродвигателей</h2>
                    ...
                    <div>
                        ...
                        <div class="uk-card-footer">
                            ...
                            <div class="uk-flex uk-flex-center uk-flex-around uk-text-small uk-text-muted ">
                                <div class="uk-card ">
                                    <a href="{{ route('categories.single', ['slug' => $category->slug]) }}" title="">{{ $category->title }}</a>
                                </div>
                                <div class="uk-card ">
                                    {{ $post->getPostDate() }}
                                </div>
